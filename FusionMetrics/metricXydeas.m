...
fuseX=imfilter(flt1,fuse,'conv');
fuseY=imfilter(flt2,fuse,'conv');
...
img1X=imfilter(flt1,img1,'conv');
img1Y=imfilter(flt2,img1,'conv');
...
img2X=imfilter(flt1,img2,'conv');
img2Y=imfilter(flt2,img2,'conv');
