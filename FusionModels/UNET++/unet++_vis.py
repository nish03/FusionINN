...
ep_ssim_train_loss_t1ce = np.array(torch.load('unet++.pt',map_location='cpu')['training_loss_ssim_t1ce'])
ep_ssim_val_loss_t1ce   = np.array(torch.load('unet++.pt',map_location='cpu')['validation_loss_ssim_t1ce'])

ep_ssim_train_loss_flair = np.array(torch.load('unet++.pt',map_location='cpu')['training_loss_ssim_flair'])
ep_ssim_val_loss_flair   = np.array(torch.load('unet++.pt',map_location='cpu')['validation_loss_ssim_flair'])
