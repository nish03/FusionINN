...
if __name__ == '__main__':
    ...
    for img_name in range(total_val_images):
        inf_img = clinical_images_numpy[img_name][0][np.newaxis,np.newaxis, ...]
        vis_img = clinical_images_numpy[img_name][1][np.newaxis,np.newaxis, ...]
        ...
        plt.imsave(os.path.join(os.path.join(out_path, 'clinical_output_full_slice'), "{}.png".format(i)),sample, cmap="gray")
        i = i+1
