...
clinical_images_tensor = torch.load("/home/h1/s8993054/INN_Fusion/Clinical_Fusion/post_img_dataset.pt")
...
with torch.no_grad():
    for idx in range(clinical_images_tensor.shape[0]):
        ...
        if count % 100 == 0:
            print(count)   
    torch.save(fused_val, 'clinical_fused_tensor_INN_full_slice.pt')
    torch.save(recon_val, 'clinical_recon_tensor_INN_full_slice.pt')
...
for i in range(clinical_images_numpy.shape[0]):
    plt.imsave('/home/h1/s8993054/INN_Fusion/Clinical_Fusion/DWI-ADC_full_slice/' + str(i) + '.png', clinical_images_numpy[i,0,], cmap = 'gray', vmin = 0.0, vmax = 1.0)
    plt.clf()
    plt.imsave('/home/h1/s8993054/INN_Fusion/Clinical_Fusion/T2-FLAIR_full_slice/' + str(i) + '.png', clinical_images_numpy[i,1,], cmap = 'gray', vmin = 0.0, vmax = 1.0)
    plt.clf()
    plt.imsave('/home/h1/s8993054/INN_Fusion/Clinical_Fusion/Fused_INN_full_slice/fused_' + str(i) + '.png', clinical_fused_numpy[i,], cmap = 'gray', vmin = 0.0, vmax = 1.0)
    plt.clf()
    plt.imsave('/home/h1/s8993054/INN_Fusion/Clinical_Fusion/Recon_INN_DWI_full_slice/Recon_DWI_' + str(i) + '.png', clinical_recon_numpy[i,0,], cmap = 'gray', vmin = 0.0, vmax = 1.0)
    plt.clf()  
    plt.imsave('/home/h1/s8993054/INN_Fusion/Clinical_Fusion/Recon_INN_Flair_full_slice/Recon_Flair_' + str(i) + '.png', clinical_recon_numpy[i,1,], cmap = 'gray', vmin = 0.0, vmax = 1.0)
    plt.clf()  
    plt.close()
